...
public class GRPCClientService {
        ...
        public FileUploadResponse fileUpload(@RequestParam("file") MultipartFile file,@RequestParam("deadline") int deadline){
                ...
                String matrixA_temp = txt2String(dest).split(symbols)[0];
                String matrixB_temp = txt2String(dest).split(symbols)[1];
        ...
        public void grpcClient(int[][]a, int[][]b, int deadline){
                ...
                String google8 = "";
-
                ManagedChannel channel1 = ManagedChannelBuilder.forAddress(google1, 9090).usePlaintext().build();  
                ManagedChannel channel2 = ManagedChannelBuilder.forAddress(google2, 9090).usePlaintext().build();  
                ManagedChannel channel3 = ManagedChannelBuilder.forAddress(google3, 9090).usePlaintext().build();  
                ManagedChannel channel4 = ManagedChannelBuilder.forAddress(google4, 9090).usePlaintext().build();  
                ManagedChannel channel5 = ManagedChannelBuilder.forAddress(google5, 9090).usePlaintext().build();  
                ManagedChannel channel6 = ManagedChannelBuilder.forAddress(google6, 9090).usePlaintext().build();  
                ManagedChannel channel7 = ManagedChannelBuilder.forAddress(google7, 9090).usePlaintext().build();  
                ManagedChannel channel8 = ManagedChannelBuilder.forAddress(google8, 9090).usePlaintext().build();  
        ...
        public static int[][] convertToMatrix(String m){
                ...
                int rows = Integer.parseInt(row_col[0].replaceAll("[\\n\\t ]", ""));
                int columns = Integer.parseInt(row_col[1].replaceAll("[\\n\\t ]", ""));
